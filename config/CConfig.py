...
class CConfig():
    ...
    def __init__(self, sReferencePath="."):
        ...
        # 1. basic setup stuff
        self.__dictConfig['sPackageName']                = "robotframework-testresult2rqmtool"
        self.__dictConfig['sImportName']                 = "RobotResults2RQM"
        ...
        self.__dictConfig['sDescription']                = "Package for importing robot result(s) to IBM Rational Quality Manager (RQM)"
        self.__dictConfig['sLongDescriptionContentType'] = "text/markdown"
        self.__dictConfig['sURL']                        = "https://github.com/test-fullautomation/robotframework-testresult2rqmtool"
