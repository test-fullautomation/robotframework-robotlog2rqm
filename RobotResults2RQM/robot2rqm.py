...
**Returns:**
   ...
   """
   cmdlineparser=argparse.ArgumentParser(prog="RobotResults2RQM (RobotXMLResult to RQM importer)", 
                                       description="RobotResults2RQM imports XML result files (default: output.xml) " + \
